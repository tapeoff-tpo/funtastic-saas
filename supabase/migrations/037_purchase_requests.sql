...
CREATE TABLE IF NOT EXISTS public.purchase_request_batches (
...
CREATE TABLE IF NOT EXISTS public.purchase_request_items (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  user_id uuid NOT NULL,
  batch_id uuid REFERENCES public.purchase_request_batches(id) ON DELETE SET NULL,
  row_number integer NOT NULL,
  status public.purchase_request_status DEFAULT 'requested' NOT NULL,
  request_date date,
  sequence integer,
