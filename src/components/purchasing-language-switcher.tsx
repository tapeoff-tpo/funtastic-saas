...
const EXACT_TRANSLATIONS: Record<string, string> = {
  ...
  '확인 필요 · 진행 중 발주에 포함된 항목': '需确认 · 已包含在进行中采购内的项目',
  '주문번호 확인 필요': '需确认订单号',
  '대량결제 잔금': '大宗付款余额',
  '대량결제를 제외한 주문번호 미입력 건': '除大宗付款外未填写订单号的项目',
  '해당 발주의 누적 선금을 제외한 남은 결제액': '该采购扣除累计预付款后的剩余付款额',
  '“확인 필요” 금액은 총액에 더하는 별도 금액이 아닙니다. 같은 진행 발주 중에서 주문번호나 대량결제 잔금 확인이 필요한 항목만 따로 보여줍니다.': '“需确认”金额不是另加到总额的金额，仅单独显示进行中采购里需要确认订单号或大宗付款余额的项目。',
