...
export default async function PurchasingRawDataPage() {
  ...
  const [[inventoryState], storedFiles] = await Promise.all([
  ...
  return (
    <div className="space-y-4">
      ...
      <PurchasingRawDataUpload today={today} inventoryUpdatedDate={inventoryUpdatedDate} initialStoredFiles={storedFiles} />
    </div>
  )
}
