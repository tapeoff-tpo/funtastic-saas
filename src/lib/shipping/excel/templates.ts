...
export const BUILT_IN_CARRIER_TEMPLATES: BuiltInCarrierTemplateDef[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { header: '사방넷 상품코드', field: 'productCode', width: 18, required: true },
      { header: '사방넷 상품명', field: 'productName', width: 34, required: false },
      { header: '사방넷 옵션', field: 'optionText', width: 26, required: false },
